...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 50Hf3fg5bP5/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: fiSPgAspR93/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 5FAYUgElqvo/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___8XRs2)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div
                  className={classNames(projectcss.all, sty.freeBox___487U6)}
                >
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__oKqr6)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__ea1AP)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__mlZtA)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
